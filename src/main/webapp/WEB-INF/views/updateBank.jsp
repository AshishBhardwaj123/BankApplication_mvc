...
<body>
    <div class="container">
        ...
        <form action="bank/updatebank" method="post">

            <label for="name">Bank Name</label>
            <input type="text" id="name" name="name" value="${bank.name}" required>

            <label for="address">Bank Address</label>
            <input type="text" id="address" name="address" value="${bank.address}" required>
